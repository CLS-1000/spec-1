...
import spec1_core.briefing.writer as _brief_writer
...
def cycle_status() -> dict:
    from spec1_core.app.cycle import last_run_state
...
def create_case(data: dict) -> dict:
    ...
    """
    try:
        from spec1_core.workspace.case import open_case
...
def list_cases_endpoint(status: str = None) -> dict:
    ...
    try:
        from spec1_core.workspace.case import list_cases
